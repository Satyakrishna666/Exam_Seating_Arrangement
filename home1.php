...
mysqli_select_db($con,'userregistration');
	...
	?>
  <div class="card-body">
    <h5 class="card-title">You can check your allotment here</h5>
    <form action="" method="POST">
				<input type="text" name="roll" placeholder="enter your roll number here">
  ...
  <thead></thead>   <tr>
    ...
    $con=mysqli_connect('localhost','root',"");
     ...
     {
     	$roll=$_POST['roll'];
     	$query="SELECT * FROM total WHERE roll='$roll'";
...
<a class="btn btn-danger" href="logoutt.php">LOGOUT</a>
