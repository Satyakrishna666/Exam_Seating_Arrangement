...
<body>
  ...
  if($_GET["error"]=="roomsize")
       {
    echo '<p class="loginerror" style="color:red">Room is filled..please go to next room</p>';
  }
}
?>
<div class="container">
	...
	<div class="row">
		<div class="col-lg-4 login-left" >
         ...
         <form action="add304db.php" method="post">
            ...
            <div class="form-group">
                <label class="radio-inline">Section</label>
                    <input type="radio" name="section" value="A" required>A</label>
                      ...
                      <button class="btn btn-primary" onclick="window.location.href='roomnumber.php'">GO BACK</button>
                  </div> </div>  
