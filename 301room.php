	...
	if($total!=0)
		{
			...
			{ echo "<tr><form action=updatee.php method=post>";
	         	...
	         	echo "<td><a href=delete.php?seatnumber=".$row['seatnumber'].">Delete</a></td>";
	         	echo  "</form></tr>";	
		} 
		echo "</table>";
	}else{
